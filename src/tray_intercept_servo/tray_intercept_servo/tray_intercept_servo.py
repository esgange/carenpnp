...
START_SEQUENCE_SERVICE_DEFAULT = 'tray_intercept_servo/start_sequence'
TRACK_SERVICE_DEFAULT = 'tray_intercept_servo/track'
TRACK_STATUS_SERVICE_DEFAULT = 'tray_intercept_servo/track_status'
...
class RelMovLMiniNode(Node):
    def __init__(self) -> None:
        super().__init__('tray_intercept_servo')
