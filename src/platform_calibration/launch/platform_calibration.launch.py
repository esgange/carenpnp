...
def generate_launch_description():
    ...
    max_marker_age_sec = LaunchConfiguration("max_marker_age_sec")
    ...
    platform_calibration = Node(
        package="platform_calibration",
        executable="platform_calibration",
        name="platform_calibration",
        output="screen",
        parameters=[{
            ...
            "max_marker_age_sec": max_marker_age_sec,
    ...
    return LaunchDescription([
        _ros_domain_action(),
        DeclareLaunchArgument("platform_name", default_value="Platform reference"),
        ...
        DeclareLaunchArgument(
            "robot_ip_address",
            default_value="",
            description="Robot controller IP for calibration filename/load filtering. Empty uses ROBOT_IP_ADDRESS/station_config.",
        ),
        DeclareLaunchArgument("marker_prefix", default_value="aruco_marker"),
        DeclareLaunchArgument("lookup_timeout", default_value="0.15"),
        DeclareLaunchArgument("max_marker_age_sec", default_value="1.5"),
